    ...
    <Fragment>
      <section className="movie-card">
        <div className="movie-card__bg">
          <img src="img/bg-the-grand-budapest-hotel.jpg" alt={movieInfoCard.titleFilm} />
        </div>
        ...
        <div className="movie-card__wrap">
          <div className="movie-card__info">
            ...
            <div className="movie-card__desc">
              <h2 className="movie-card__title">{movieInfoCard.titleFilm}</h2>
              <p className="movie-card__meta">
                <span className="movie-card__genre">{movieInfoCard.genreFilm}</span>
                <span className="movie-card__year">{movieInfoCard.releaseDate}</span>
              </p>
        ...
        <section className="catalog">
          ...
          <ul className="catalog__genres-list">
            ...
            <li className="catalog__genres-item">
              <Link to="/" href="#" className="catalog__genres-link">Comedies</Link>
            </li>
            <li className="catalog__genres-item">
