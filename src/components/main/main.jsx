        ...
        <div className="movie-card__wrap">
          <div className="movie-card__info">
            ...
            <div className="movie-card__desc">
              <h2 className="movie-card__title">{movieInfoCard.title}</h2>
              <p className="movie-card__meta">
                <span className="movie-card__genre">{movieInfoCard.genre}</span>
                <span className="movie-card__year">{movieInfoCard.year}</span>
              </p>
